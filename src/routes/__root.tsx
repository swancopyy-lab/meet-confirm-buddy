...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "منصة دعوات الزفاف" },
      { name: "description", content: "منصة تأكيد حضور الزفاف بباركود لكل دعوة" },
      { property: "og:title", content: "منصة دعوات الزفاف" },
      { name: "twitter:title", content: "منصة دعوات الزفاف" },
      { property: "og:description", content: "منصة تأكيد حضور الزفاف بباركود لكل دعوة" },
      { name: "twitter:description", content: "منصة تأكيد حضور الزفاف بباركود لكل دعوة" },
